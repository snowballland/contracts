...
abstract contract StratSbt2 is Ownable, ReentrancyGuard, Pausable {
    ...
    address public farmContractAddress; // address of farm, eg, PCS, BAKE etc.
    ...
    uint256 public constant controllerFeeUL = 7000;

    uint256 public buyBackRate = 0; // 250;
    uint256 public constant buyBackRateMax = 10000; // 100 = 1%
    uint256 public constant buyBackRateUL = 7000;
